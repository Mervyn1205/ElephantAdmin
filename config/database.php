...
return [
    ...
    'type'            => 'mysql',
    // 服务器地址
    'hostname'        => Env::get('DATABASE.DEFAULT_HOST', '127.0.0.1'),
    // 数据库名
    'database'        => Env::get('DATABASE.DEFAULT_DATABASE', ''),
    // 用户名
    'username'        => Env::get('DATABASE.DEFAULT_USERNAME', 'root'),
    // 密码
    'password'        => Env::get('DATABASE.DEFAULT_PASSWORD', ''),
    // 端口
    'hostport'        => Env::get('DATABASE.DEFAULT_PORT', '3306'),
    // 连接dsn
    'dsn'             => '',
    // 数据库连接参数
    'params'          => [],
    // 数据库编码默认采用utf8
    'charset'         => Env::get('DATABASE.DEFAULT_CHARSET', 'utf8mb4'),
    // 数据库表前缀
    'prefix'          => 't_',
    // 数据库调试模式
